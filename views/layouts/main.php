                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="javascript:void(0);" onclick="return getCart()"><i class="fa fa-shopping-cart"></i> Cart</a></li>
...
<!--/Footer-->
<?php
/* -- Пример из урока (не работает) */
\yii\bootstrap4\Modal::begin([
    'title' => '<h2 class="title text-center">Basket</h2>',
    'id' => 'cart',
    'size' => 'modal-lg',
    'footer' => '<button type="button" class="btn btn-default" data-dismiss="modal">Continue</button>
        <a href="' . \yii\helpers\Url::to(['cart/view']) . '" class="btn btn-success">Make order</a>
        <button type="button" class="btn btn-danger" onclick="clearCart()">Cleaen basket</button>'
]);
