                    ...
                    <div class="col-sm-5">
                        ...
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <?php echo ($i % 3 == 0 ? '<div class="item ' . ($i == 0 ? 'active' : '') . '">' : '') ?>
                                    <a href="#">
                                        <?= Html::img($img->getUrl('85x84'), ['alt' => $img->name]); ?>
                                    </a>
                                <?php $i++; echo (($i % 3 == 0 || $i == $count) ? '</div>' : '') ?>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information">
                            ...
                            <?php elseif ($product->sale): ?>
                                <?=Html::img('@web/images/product-details/sale.png', ['alt' => 'Скидка', 'class' => 'newarrival']) ?>
                            <?php endif; ?>
                            <h2><?=$product->name ?></h2>
                            <p>Web ID: 1089772</p>
                            ...
                            <p><b>Condition:</b>
                                <?php if ($product->new): ?> New<?php elseif ($product->sale): ?> Sale<?php else: ?> Usual<?php endif; ?>
                            </p>
